...
if (($_SESSION[$sn]%$config[num_banner_session])==0) {
...
if ($b[tipo]=="flash") {
print "<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0\" width=\"$b[largura]\" height=\"$b[altura]\">
...
print "<a href=\"".$config[site_url]."/click.php?b_id=".$b_id."\" target=\"_blank\"><img border=\"0\" src=\"$b[url]\" width=\"$b[largura]\" height=\"$b[altura]\" /></a>";
} } }
